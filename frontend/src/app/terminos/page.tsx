...
export const metadata: Metadata = {
  ...
  description: 'Condiciones de uso de la plataforma Cookr — red social gastronómica.',
}
      ...
      <main className="mx-auto w-full max-w-3xl px-5 py-12 md:px-10 md:py-16">
        ...
        <div className="mb-10">
          ...
          <p className="mt-5 text-base leading-relaxed text-muted-foreground">
            Bienvenido a <strong className="text-foreground">Cookr</strong>. Al crear una cuenta o
        ...
        <article className="space-y-12 text-[0.9375rem] leading-relaxed">
          ...
          <section id="aceptacion">
            ...
            <p className="text-muted-foreground">
              ...
              <strong className="text-foreground">14 años</strong>, que has leído y entendido estos
              términos y que aceptas quedar vinculado por ellos. Si utilizas Cookr en nombre de una
              organización, declaras que tienes autoridad para aceptar estos términos en su nombre.
            </p>
          </section>
          ...
          <section id="descripcion">
            ...
            <p className="mb-4 text-muted-foreground">
              Cookr es una <strong className="text-foreground">red social gastronómica</strong> que
            ...
            <ul className="ml-5 list-disc space-y-1.5 text-muted-foreground">
              ...
              <li>
                Activar el Modo Manos Libres para escuchar los pasos de una receta en voz alta
              </li>
            </ul>
            <p className="mt-4 text-muted-foreground">
              El servicio se ofrece en formato de aplicación web progresiva (PWA), instalable en
              dispositivos móviles y accesible también desde navegadores de escritorio.
            </p>
          </section>

          {/* 3 */}
          <section id="cuenta">
            <h2 className="mb-4 text-xl font-semibold text-foreground">3. Tu cuenta</h2>
            <div className="space-y-4 text-muted-foreground">
              <p>
                Puedes registrarte con{' '}
                <strong className="text-foreground">correo electrónico y contraseña</strong> o
                mediante <strong className="text-foreground">Google OAuth</strong>. Eres responsable
                de mantener la confidencialidad de tus credenciales.
              </p>
              <p>
                Debes proporcionar información veraz y mantenerla actualizada. Nos reservamos el
                derecho a suspender o eliminar cuentas que violen estos términos, suplanten
                identidades o proporcionen información falsa.
              </p>
              <p>
                Puedes eliminar tu cuenta en cualquier momento desde los ajustes. Consulta nuestra{' '}
          ...
          <section id="contenido">
            <h2 className="mb-4 text-xl font-semibold text-foreground">4. Contenido del usuario</h2>
            <div className="space-y-4 text-muted-foreground">
              <p>
                Al publicar recetas, imágenes, comentarios u otro contenido en Cookr, conservas la{' '}
                <strong className="text-foreground">propiedad</strong> sobre ese contenido, pero nos
                concedes una licencia mundial, no exclusiva y gratuita para mostrarlo, almacenarlo y
                distribuirlo dentro de la plataforma.
              </p>
              <p>
                Eres el único responsable del contenido que publicas. No debes subir contenido que:
              </p>
              <ul className="ml-5 list-disc space-y-1.5">
                <li>Infrinja derechos de autor, marcas u otros derechos de terceros</li>
                <li>
                  Sea falso, engañoso o contenga información nutricional incorrecta a sabiendas
                </li>
              ...
              <p>
                Nos reservamos el derecho a retirar cualquier contenido que incumpla estas normas,
          ...
          <section id="uso-aceptable">
            <h2 className="mb-4 text-xl font-semibold text-foreground">5. Uso aceptable</h2>
          ...
          <section id="ia">
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                ...
                <strong className="text-foreground">Google Gemini</strong>. Las respuestas generadas
                son <strong className="text-foreground">orientativas</strong> y pueden contener
                imprecisiones, especialmente en materia de:
              </p>
              ...
              <div className="border-destructive/20 bg-destructive/5 rounded-lg border px-4 py-3 text-sm">
                <strong className="text-foreground">Importante:</strong> No uses las recomendaciones
                del asistente de IA como sustituto de consejo médico o dietético profesional.
                Consulta siempre a un especialista para información relacionada con salud, alergias
                o condiciones médicas.
              </div>
              <p>
                Los mensajes enviados al asistente de IA son procesados por los servidores de
                Google. Consulta la{' '}
                <a
          ...
          <section id="propiedad">
            <h2 className="mb-4 text-xl font-semibold text-foreground">7. Propiedad intelectual</h2>
            <p className="text-muted-foreground">
              El código fuente, el diseño, los logotipos y los textos de Cookr son propiedad del
              autor del TFG y están protegidos por la legislación de propiedad intelectual
              aplicable. No puedes reproducir, distribuir ni crear obras derivadas sin autorización
              expresa, excepto cuando sea necesario para el uso normal de la plataforma. Las recetas
              publicadas por los usuarios pertenecen a sus autores respectivos.
            </p>
          </section>
          ...
          <section id="disponibilidad">
            ...
            <p className="text-muted-foreground">
              Cookr se ofrece «tal cual» y «según disponibilidad». Al tratarse de un proyecto
              académico, no garantizamos una disponibilidad del 100 % ni un tiempo de respuesta de
              soporte determinado. Podemos interrumpir, modificar o discontinuar cualquier parte del
              servicio en cualquier momento, especialmente al término del período académico del TFG.
            </p>
          </section>
          ...
          <section id="responsabilidad">
            ...
            <p className="text-muted-foreground">
              En la máxima medida permitida por la ley aplicable, Cookr y su autor no serán
              responsables de:
            </p>
          ...
          <section id="cambios">
            ...
            <p className="text-muted-foreground">
              Podemos actualizar estos términos en cualquier momento. Notificaremos los cambios
              sustanciales por correo electrónico o mediante un aviso en la aplicación con al menos{' '}
              <strong className="text-foreground">7 días</strong> de antelación. El uso continuado
