...
> Reglas: `docs/rules.md` · `docs/folderStructure.md` · `docs/infraestructura.md`
...
### Documentación HTML
Cada cambio actualiza o crea el HTML correspondiente en `docs/desarrollo/`:
...
**Docs a actualizar:** `docs/desarrollo/integracionRecetas.html` — añadir sección "Metadatos dinámicos (DET-010)"
...
Actualizar `docs/desarrollo/funcionalidadSocial.html`:
...
- La infraestructura doc en `docs/infraestructura.md` menciona Web Speech API + Navigator Wake Lock
...
Crear `docs/desarrollo/modoManoLibres.html`:
...
Actualizar `docs/desarrollo/discoverHomeIntegracion.html`:
...
Crear `docs/desarrollo/authRefactor.html`:
...
**Docs:** actualizar `docs/desarrollo/discoverHomeIntegracion.html`
...
**Docs:** actualizar `docs/desarrollo/despensaIntegracion.html`
...
**Docs:** crear `docs/desarrollo/optimizacionRendimiento.html`
...
| Fase | Acción | Archivo |
|---|---|---|
| 1 — ALEG-001 | Crear | `docs/desarrollo/integracionRecetas.html` |
| 1 — DET-010 | Crear | `docs/desarrollo/integracionRecetas.html` |
| 2 — DET-004 | Actualizar | `docs/desarrollo/funcionalidadSocial.html` |
| 3 — HANDS-001 | Crear | `docs/desarrollo/modoManoLibres.html` |
| 4 — TEND-001 | Actualizar | `docs/desarrollo/discoverHomeIntegracion.html` |
| 5 — Refactors | Crear | `docs/desarrollo/authRefactor.html` |
| FEED-SMART-001 | Actualizar | `docs/desarrollo/discoverHomeIntegracion.html` |
| DESP-003 | Actualizar | `docs/desarrollo/despensaIntegracion.html` |
| PERF-SSR-001 | Crear | `docs/desarrollo/optimizacionRendimiento.html` |
| Todas | Actualizar contadores | `docs/desarrollo/estadoTareas.html` |
