...
`METODO-DE-TRABAJO.md` describe cómo está montado DietMetric para trabajar con Claude Code. Este
...
pendiente** (`PLAN-2026-09.md`). Cualquier andamiaje que cueste más de lo que ahorre en ese plazo
...
| `docs/stitch/`, `docs/phase-reports/`, `docs/changes/` | Material histórico. Si algo hay que actualizar, va en un documento nuevo con fecha |
...
El diario, más simple que el de DietMetric: `docs/diario.md`, una entrada por sesión de trabajo,
...
- **El plan de 23 paquetes con fichas.** `PLAN-2026-09.md` ya es eso con la granularidad que pide
...
Nada de esto arregla un fallo. `PLAN-2026-09.md` pone el bloque de método el último a propósito, y
