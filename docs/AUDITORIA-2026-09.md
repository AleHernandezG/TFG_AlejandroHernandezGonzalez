...
El plan de ejecución sale a `PLAN-2026-09.md`. Este documento solo diagnostica.
...
sigue vigente. `docs/api-contracts/` está **vacía**. La mayoría de los `.md` son de marzo a junio:
...
- **No hay contrato de API.** `docs/api-contracts/` existe y está vacía. Los 37 endpoints solo se
...
se escribe como ADR con su alternativa descartada. Detalle en `PLAN-2026-09.md`, bloque F0.
