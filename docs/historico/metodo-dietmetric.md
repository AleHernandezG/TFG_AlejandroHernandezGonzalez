...
> Copia del documento de DietMetric. Los enlaces internos (`ESTRUCTURA.md`, `adr/`, `plan/`)
> apuntan a ficheros de aquel repositorio y no existen aquí. Lo que de esto aplica a Cookr está
> filtrado en `docs/referencia/metodo-cookr.md`.
