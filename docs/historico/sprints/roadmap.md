...
| `ui-changes.md` | `docs/historico/cambios/` | Cambios visuales |
| `api-changes.md` | `docs/historico/cambios/` | Cambios de endpoints |
| `domain-changes.md` | `docs/historico/cambios/` | Cambios de modelo de datos |
