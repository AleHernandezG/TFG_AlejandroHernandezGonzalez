...
> Fuente canónica: `docs/historico/context.md`, `docs/referencia/estructura-frontend.md`, `docs/historico/fases/tech-debt.md`.
...
2. Guardar en `docs/diseno/stitch/<nombreVista>/`: `<nombre>.png` + `<nombre>.html`
