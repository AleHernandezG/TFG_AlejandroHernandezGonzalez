...
> **Cambio visual:** [UI-022] — ver `docs/historico/cambios/ui.md`
...
Ver `docs/historico/fases/fase-1-sprint-1-registro.md` para la arquitectura completa del feature auth.
