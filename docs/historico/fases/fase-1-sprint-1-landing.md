...
- Documentación técnica completa creada en `docs/historico/desarrollo/landingPage.md`
...
- `docs/historico/fases/fase-1-sprint-1-carrousel-completados.md`
- `docs/historico/desarrollo/landingPage.md`
...
- Nuevo archivo `docs/historico/fases/tech-debt.md` con registro de deuda técnica (DEBT-001: eslint@8 + next-pwa@5)
...
- `docs/historico/fases/tech-debt.md`
- `docs/landing.html`
...
- `frontend/src/app/layout.tsx`
- `docs/historico/context.md`
- `docs/historico/fases/fase-0-pendientes.md`
