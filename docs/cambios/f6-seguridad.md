...
Registro de lo que se tocó en el bloque F6 de `docs/estado/plan-2026-09.md`, con las decisiones que
...
- **El login con Google real no se ha probado contra Google.** Los tests mockean
  ...
  pasos y los síntomas de cada fallo, está en `docs/estado/pruebas-manuales.md`.
